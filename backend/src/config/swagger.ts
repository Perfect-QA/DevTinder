...
const options: swaggerJsdoc.Options = {
  ...
  apis: [
    './src/routes/auth.ts',
    './src/routes/testGeneration.ts',
    './src/routes/profile.ts',
    './src/routes/user.ts',
    './src/controllers/auth/*.ts',
    './src/controllers/testGenerationController.ts',
    './dist/src/routes/auth.js',
    './dist/src/routes/testGeneration.js',
    './dist/src/routes/profile.js',
    './dist/src/routes/user.js',
    './dist/src/controllers/auth/*.js',
    './dist/src/controllers/testGenerationController.js',
  ],
};
